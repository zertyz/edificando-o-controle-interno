...
// MSaaSModule
import { MSaaSModule } from '../modules/m-SaaS/m-SaaS.module';
// NgbModule
...
export const MutuaExportedModules: any[] = [BrowserAnimationsModule,MHelloWorldModule.forRoot(),MSaaSModule.forRoot(),NgbModule.forRoot(),...PRIMENG_MODULES];
